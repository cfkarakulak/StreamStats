                  ...
                  <tr v-for="(row, i) in localRows" :key="i" class="vtl-tbody-tr">
                    ...
                    >
                      ...
                      <template v-else>
                        ...
                        <span v-else v-html="row[col.field]"></span>
                      </template>
                    </td>
                  </tr>
                </template>
...
.vtl-paging-pagination-page-link-next span {
  display: none !important;
}

.vtl-paging-pagination-page-li-prev a,
.vtl-paging-pagination-page-li-next a {
  width:32px;
  height:26px;
}

.vtl-paging-pagination-page-li-prev.disabled,
.vtl-paging-pagination-page-li-next.disabled {
  opacity:0.6;
}

.vtl-paging-pagination-page-li-prev a:before{
  content: "";
  width: 12px;
  height: 12px;
  display: block;
...
.vtl-paging-pagination-page-li-next a:after{
  content: "";
  width: 12px;
  height: 12px;
  display: block;
